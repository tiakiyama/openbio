        ...
        <div className="mt-10 pt-10 border-t border-gray-800 lg:mt-12 lg:pt-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                <p className="text-xs text-gray-500 mb-1">Suporte 0800</p>
            ...
            <div className="flex flex-col gap-4">
              <div>
                <p className="text-xs text-gray-500 mb-1">Comercial</p>
              ...
              <div>
                <p className="text-xs text-gray-500 mb-1">Suporte ao Cliente</p>
            ...
            <div className="flex flex-col gap-4">
              <div>
                <p className="text-xs text-gray-500 mb-1">Licitações</p>
